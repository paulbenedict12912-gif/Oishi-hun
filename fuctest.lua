...
for i, tab in ipairs(Tabs) do
    ...
    btn.Size = UDim2.new(1/4, -1, 0, 22)
    btn.Position = UDim2.new((i-1) * (1/4), 0.5, 0, 2)
...
local function createESPElements(player)
    ...
    if SaveData.EspBoxes then
        ...
        elements.Box = newDrawing("Square", {
            ...
            Thickness = 1.5, 
            Filled = false, 
            Color = SaveData.EspBoxColor or Color3.fromRGB(0, 150, 255)
        })
    end
    ...
    if SaveData.EspNames then
        elements.Name = newDrawing("Text", {
            ...
            Size = 13, 
            Font = 2, 
            Color = SaveData.EspNameColor or Color3.new(1, 1, 1)
        })
    end
    ...
    if SaveData.EspHealth then
        ...
        elements.HealthBar = newDrawing("Line", {
            Visible = false, 
            Thickness = 3, 
            Color = SaveData.EspHealthColor or Color3.new(0, 1, 0)
        })
    end
    ...
    if SaveData.EspDistance then
        elements.Distance = newDrawing("Text", {
            ...
            Size = 11, 
            Font = 2, 
            Color = SaveData.EspDistanceColor or Color3.new(1, 1, 1)
        })
    end
    ...
    if SaveData.EspHealthNumber then
        elements.HealthNumber = newDrawing("Text", {
            ...
            Size = 11, 
            Font = 2, 
            Color = SaveData.EspHealthNumberColor or Color3.new(1, 1, 1)
        })
    end
    ...
    if SaveData.EspTracers then
        elements.Tracer = newDrawing("Line", {
            Visible = false, 
            Thickness = 1, 
            Color = SaveData.EspTracerColor or Color3.fromRGB(0, 150, 255)
        })
    end
